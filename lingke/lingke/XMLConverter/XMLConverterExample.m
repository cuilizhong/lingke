...
+ (void)example {
  ...
  ///Examle 3 - 5: XML String Convertion
  ...
  [XMLConverter convertXMLString:xmlAnotherString completion:^(BOOL success, NSDictionary *dictionary, NSError *error)
   {
    ...
    NSString *xmlWithDuplicateLeafNodesString = @"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n<A>\n  <m>\n    <n>77</n>\n    <u>jj</u>\n  </m>\n  <m>\n    <n>88</n>\n    <u>abc</u>\n  </m>\n  <x>(5600)</x>\n  <x>(5601)</x>\n  <x>(5602)</x>\n  <x>(5603)</x>\n  <y>0211</y>\n  <y>0212</y>\n  <y>0223</y>\n  <y>0224</y>\n</A>";
    NSLog(@"%@", xmlString);
    [XMLConverter convertXMLString:xmlWithDuplicateLeafNodesString completion:^(BOOL success, NSDictionary *dictionary, NSError *error)
     {
        NSLog(@"\n\n***************************Example 5******************************\n\n");
        NSLog(@"%@", success ? dictionary : error);
        NSLog(@"\n******************************************************************");
